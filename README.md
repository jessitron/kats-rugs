...
[![Build Status](https://travis-ci.org/mygroup/elm-katz-rugs.svg?branch=master)](https://travis-ci.org/mygroup/elm-katz-rugs)
...
```
$ cd to/the/repo
$ rug edit mygroup:elm-katz-rugs:AddReadme \
...
[issue]: https://github.com/mygroup/elm-katz-rugs/issues
